...
def detect_drowsiness_combined(yaw, pitch, roll, movement_threshold=3, pitch_threshold=30, duration=30):
    ...
    return (dyaw < movement_threshold and dpitch < movement_threshold and droll < movement_threshold) and pitch > pitch_threshold
